...
def farenConvert():
    ...
    if (proceed == True):
        ...
        my_text = str(originTemp) + " degrees C is " + \
            str(changeTemp) + " degrees in F"
...
def celConvert():
    ...
    if (proceed == True):
        ...
        changeTemp = round(changeTemp, 2)
        my_text = str(originTemp) + " degrees F is " + \
            str(changeTemp) + " degrees in C"
        templabel.config(text=my_text)
    else:
        my_text = "Thats not a number, Enter again"
        templabel.config(text=my_text)
...
def poundConvert():
    ...
    if (proceed == True):
        ...
        my_text = str(originWeight) + " Kilograms is " + \
            str(changeWeight) + " Pounds"
...
def kiloConvert():
    ...
    if (proceed == True):
        ...
        changeWeight = round(changeWeight, 2)
        my_text = str(originWeight) + " Pounds is " + \
            str(changeWeight) + " Kilograms"
        weightLabel.config(text=my_text)
    else:
        my_text = "Thats not a number, Enter again"
        weightLabel.config(text=my_text)
